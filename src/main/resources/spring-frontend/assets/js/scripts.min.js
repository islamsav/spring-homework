                        ...
                        switch (data) {
                            ...
                            case'recent':
                                getData('/books/recent', {
                                    ...
                                    to: $('[data-refreshto]').data('refreshto'),
                                    offset: function () {
                                        var oldOfset = $this.data('refreshoffset');
                                        if (oldOfset < 1) {
                                            $this.data('refreshoffset', ++oldOfset);
                                        } else {
                                            $this.data('refreshoffset', ++oldOfset - $this.data('refreshlimit'));
                                        }
                                        return $this.data('refreshoffset');
                                    },
                                    limit: $this.data('refreshlimit')
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/changeBookStatus/vote/' + $this.data('bookid'), {

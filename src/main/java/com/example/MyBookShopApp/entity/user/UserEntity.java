...
import com.example.MyBookShopApp.entity.review.BookReviewLike;
import com.example.MyBookShopApp.entity.review.Message;
import lombok.*;
...
//  Список отзывов на которые оставлены лайк или дизлайк
    private Set<BookReviewLike> bookReviewLike;
